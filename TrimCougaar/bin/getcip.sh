...
echo Getting core cougaar $cougaar_url_base/cougaar.zip 
curl -o cougaar.zip $cougaar_url_base/cougaar.zip 

echo Getting third-party jars $cougaar_url_base/cougaar-support.zip
curl -o cougaar-support.zip $cougaar_url_base/cougaar-support.zip

#echo Getting optional: cougaar javadoc $cougaar_url_base/cougaar-api.zip
#curl -o cougaar-api.zip $cougaar_url_base/cougaar-api.zip

echo Getting optional cougaar sources $cougaar_url_base/cougaar-src.zip
...
echo Getting tutorial tools $cougaar_url_base/demo-tools.zip
